...
<div align="center">
	<form name="join" method="post" action="modify.jsp">
		<table width="622" height="536" border="1" cellspacing="0" cellpadding="0" bordercolor="#A3C2F6">
			<tr>
				<td width="15%" align="right"><font color="#FF0000" size=1>★</font><font class="style2">아이디&nbsp;&nbsp;</font></td>
				<td width="75%">&nbsp;
				<input type="text" name="userid" size="16" maxlength="16" class="box" value="<%=userid %>" readonly>
			</tr>
			<tr>
				<td width="15%" align="right"><font color="#FF0000" size=1>★</font><font class="style2">비밀번호&nbsp;&nbsp;</font></td>
				<td width="75%">&nbsp;
				<input type="password" name="password" size="12" maxlength="12" class="box" value="<%=password %>">
				<font class="style2">다시한번&nbsp;&nbsp;</font>
				<input type="password" name="password2" size="12" maxlength="12" class="box" value="<%=password %>">
				<font class="style2">(영문+숫자 4~12자리)&nbsp;&nbsp;</font>			
			</tr>
			<tr>
			...
			<tr>
				<td width="15%" align="right"><font color="#FF0000" size=1>★</font><font class="style2">주민등록번호&nbsp;&nbsp;</font></td>
				<td width="75%">&nbsp;
				<input type="text" name="securitynum1" size="6" maxlength="6" class="box" value="<%=securitynum1 %>" readonly> -
			...
			<tr>
				...
				<td width="75%">&nbsp;
				<input type="text" name="zipcode1" size="3" maxlength="3" class="box" value="<%=zipcode1 %>" readonly> -
				<input type="text" name="zipcode2" size="3" maxlength="3" class="box" value="<%=zipcode2 %>" readonly>
				<input type="button" name="button" onClick="MM_openBrWindow('zipcode_search.jsp', 'zipcodesearch','scrollbars=yes, width=500,height=250')" value"우편번호 검색">
