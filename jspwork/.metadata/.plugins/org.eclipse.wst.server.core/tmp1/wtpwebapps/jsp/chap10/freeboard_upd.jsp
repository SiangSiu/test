...
<form name="msgwrite" method=post action="freeboard_upddb.jsp?id=<%=id %>&page=<%=p %>">
	<table width="600" cellspacing="0" cellpadding="2" align="center">
		...
		<tr>
			<td width="124" height="162" align="center" valign="tob" bgcolor="#f4f4f4" style="padding-top:7;">내  용</td>
			<td width="494" valign="top" style="padding:5 0 5 10">
				<textarea rows="10" cols="65" name=content class="textarea_style1"><%=rs.getString("content") %> </textarea>
			</td> 
		</tr>
		<tr>
			...
			<td colspan="2" align="right">
				<table width="100%" border="0" cellpadding="0" cellspacing="0" >
					<tr>
						...
						<td width="12%"><a href="#" onClick="freeboard_list.jsp?go=<%=request.getParameter("page") %>"><img src="image/list.jpg" border="0"></a></td>
					</tr>
				</table>
			</td>
		</tr>
